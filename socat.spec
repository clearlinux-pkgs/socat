...
Source0  : http://www.dest-unreach.org/socat/download/socat-1.7.4.4.tar.gz
...
%prep
%setup -q -n socat-1.7.4.4
cd %{_builddir}/socat-1.7.4.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667193701
