...
%prep
%setup -q -n socat-1.7.3.4
cd %{_builddir}/socat-1.7.3.4
%patch1 -p1
%patch2 -p1
...
cp %{_builddir}/socat-1.7.3.4/COPYING.OpenSSL %{buildroot}/usr/share/package-licenses/socat/82fcde476cb04d2b68f9a47c5c64f00019f6d821
%make_install
