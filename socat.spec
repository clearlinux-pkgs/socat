...
Source0  : http://www.dest-unreach.org/socat/download/socat-1.8.0.1.tar.gz
...
%prep
%setup -q -n socat-1.8.0.1
cd %{_builddir}/socat-1.8.0.1
%patch -P 1 -p1
pushd ..
cp -a socat-1.8.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724518320
